...
class _EditProjectState extends State<EditProject> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Edit Project', style: TextStyle(fontSize: 24)),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          const Text('Project Title', style: TextStyle(fontSize: 16, 
          ...
          const Text('Todo Items', style: TextStyle(
            fontSize: 16, 
            fontWeight: FontWeight.bold)),
          const SizedBox(height: 8),
          Row(children: [
          ...
          if (_todoItems.isNotEmpty)
            ListView.builder(shrinkWrap: true, physics: const NeverScrollableScrollPhysics(), itemCount: _todoItems.length, itemBuilder: (context, index) {
              ...
              trailing: IconButton(icon: const Icon(Icons.clear_rounded, color: Colors.red), 
